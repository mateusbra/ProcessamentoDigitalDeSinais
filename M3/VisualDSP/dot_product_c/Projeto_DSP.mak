...
#
# Begin "Projeto_DSP_Debug" configuration
#

ifeq ($(MAKECMDGOALS),Projeto_DSP_Debug)

Projeto_DSP_Debug : ./Debug/Projeto_DSP.dxe 

Debug/dotprod.doj :dotprod.c 
	@echo ".\dotprod.c"
	$(VDSP)/ccblkfn.exe -c .\dotprod.c -file-attr ProjectName=Projeto_DSP -g -structs-do-not-overlap -no-multiline -double-size-32 -decls-strong -warn-protos -proc ADSP-BF533 -o .\Debug\dotprod.doj -MM
